...
def args_parser():
    ...
    parser.add_argument('--fusionType',type=str,default='block')
    # data split scheme
    ...
    parser.add_argument('--classNum',type=int,default=12,help='two class or five class or three class')
    ...
    parser.add_argument('--ratioW', type=float, default=1)
    parser.add_argument('--mu',type=float,default=0.2)

    parser.add_argument('--thred', type=float, default=0.01)
